...
<template>
  ...
  <ice-dropdown size="small" :options="menu" @select="handleMenuSelect">
  ...
  <ice-dropdown :max-height="200">
    <ice-button>选一个好地方</ice-button>
    <template #dropdown>
      <ice-dropdown-menu>
        <ice-scrollbar max-height="200px" :thumb-size="6">
